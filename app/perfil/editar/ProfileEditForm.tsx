...
export default function ProfileEditForm({ profile, locations }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      {/* Display name */}
      <div>
        <label className="block text-sm font-semibold text-gray-700 mb-1" htmlFor="display_name">
      ...
      {/* Bio */}
      <div>
        <label className="block text-sm font-semibold text-gray-700 mb-1" htmlFor="bio">Bio</label>
        <textarea
          id="bio"
          value={bio}
      ...
      {/* City */}
      <div>
        <label className="block text-sm font-semibold text-gray-700 mb-1" htmlFor="city">Ciudad</label>
        <select
          id="city"
          value={city}
      ...
      {/* WhatsApp */}
      <div>
        <label className="block text-sm font-semibold text-gray-700 mb-1" htmlFor="whatsapp">
          Número de WhatsApp
        </label>
