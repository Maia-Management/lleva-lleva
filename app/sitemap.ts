...
const BASE_URL = 'https://llevalleva.co';
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/publicar`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
  ...
  try {
    ...
    // If DB is unreachable (e.g. during static build), return static routes only
    return staticRoutes;
  }
}
