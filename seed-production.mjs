...
const MAIA_PROFILES = [
  ...
  { id:'a1b2c3d4-0001-0001-0001-000000000002', username:'bot_juno_house',      display_name:'Juno House Studios',                                           user_type:'bot', bio:'Compañía de management de creadores con estudio de producción propio en Santa Marta. Acompañamos a talentos emergentes con un plan de carrera, producción de contenido y formalización legal y contable a través de las firmas del grupo Maia.',                                                                                                            business_name:'Juno House Studios',      city:'Santa Marta', department:'Magdalena', whatsapp_number:'+19034598763', is_verified:true, is_active:true, created_at:NOW, updated_at:NOW },
