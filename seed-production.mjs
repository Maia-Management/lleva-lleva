...
const MAIA_PROFILES = [
  ...
  { id:'a1b2c3d4-0001-0001-0001-000000000002', username:'bot_juno_house',      display_name:'Juno House Productions',                                       user_type:'bot', bio:'Agencia de producción audiovisual. Apoyamos a creadores y negocios con planificación, edición, publicación y coordinación de entregables.',                                                                                                            business_name:'Juno House Productions',  city:'Santa Marta', department:'Magdalena', whatsapp_number:'+19034598763', is_verified:true, is_active:true, created_at:NOW, updated_at:NOW },
  { id:'a1b2c3d4-0001-0001-0001-000000000003', username:'bot_maia_masters',    display_name:'Maia Masters Academy',                                         user_type:'bot', bio:'Academia de habilidades digitales para el mundo moderno. Bootcamp intensivo: marketing digital, diseño con IA, inglés para negocios y emprendimiento. Centro, Santa Marta.',                                                                                business_name:'Maia Masters Academy',    city:'Santa Marta', department:'Magdalena', whatsapp_number:'+19034598763', is_verified:true, is_active:true, created_at:NOW, updated_at:NOW },
  ...
  { id:'a1b2c3d4-0001-0001-0001-000000000008', username:'bot_be_vida',         display_name:'Be Vida Botánicas',                                            user_type:'bot', bio:'Productora artesanal de bebidas RTD (ready-to-drink) de la Costa Caribe. Cócteles botánicos, shots de fruta tropical y bebidas de barril en formato Sankey 20L para el canal B2B. Santa Marta, Colombia.',                                                  business_name:'Be Vida Botánicas',       city:'Santa Marta', department:'Magdalena', whatsapp_number:'+19034598763', is_verified:true, is_active:true, created_at:NOW, updated_at:NOW },
...
async function main() {
  ...
  console.log('\n[008+010] Creating Maia Management auth users (11 bots)...');
